...
training_steps=2000
model_dir="ldm_posterior_training_$training_steps"
...
do
    ...
    python main.py --base configs/latent-diffusion/lsun_bedrooms_posterior.yaml --max_steps $training_steps \
        --train_txt_path "$data_root_dir/bedrooms_train.txt" --val_txt_path \
    "$data_root_dir/bedrooms_val.txt" --root_dir $data_dir --channel_snr $snr --gpus=1 \
