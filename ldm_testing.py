...
if __name__=="__main__":
    ...
    if DENOISE_LATENT is True:
        filename = f"post_exp_metrics/latent_diffusion_expts/ldm_scores_{int(TEST_SNR)}_dict.pkl"

    else:
        filename = f"post_exp_metrics/latent_diffusion_expts/noisy_latent_scores_{int(TEST_SNR)}_dict.pkl"
