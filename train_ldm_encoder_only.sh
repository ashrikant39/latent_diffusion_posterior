...
#SBATCH --job-name=ldm_encoder_only
...
model_dir="ldm_encoder_only_$training_steps"
...
do
    ...
    python main_jscc.py --base configs/latent-diffusion/ldm_encoder_only.yaml --max_steps $training_steps \
