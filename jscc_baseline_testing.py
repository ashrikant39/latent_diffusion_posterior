...
if __name__=="__main__":
    ...
    LOGDIR = glob.glob(os.path.join(LOGDIR, f"snr_{TRAIN_SNR}", "*"))[0]
    ...
    filename = os.path.join(LOGDIR, f"train_{TRAIN_SNR}_test_{TEST_SNR}_metrics.pkl")
