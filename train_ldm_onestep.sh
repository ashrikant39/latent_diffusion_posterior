...
training_steps=2000
model_dir="ldm_no_ema_encoder_model_$training_steps"
...
do
    ...
    python main_jscc.py --base configs/latent-diffusion/lsun_bedrooms_onestep.yaml --max_steps $training_steps \
